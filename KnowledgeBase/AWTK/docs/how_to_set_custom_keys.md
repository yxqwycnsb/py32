...
关于 MVVM 命令参数的更多资料请参阅[ AWTK-MVVM 命令绑定 ](https://github.com/zlgopen/awtk-mvvm/blob/master/docs/11.command_binding.html)。

## 三、其它

  * awtk-linux-fb，请在 awtk_config.py 中定义下面的宏。
