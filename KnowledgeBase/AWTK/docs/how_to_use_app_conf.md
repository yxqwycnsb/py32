...
AWTK 提供了 [app_conf](https://github.com/zlgopen/awtk/blob/master/docs/manual/app_conf_t.html) 接口，用于保存或读取应用程序的配置信息。其特点有：
...
[app_conf](https://github.com/zlgopen/awtk/blob/master/docs/manual/app_conf_t.html) 作为可选组件，需要开发者自己初始化。
