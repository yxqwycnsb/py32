...
#### 基本属性
  ...
  * bg_image 背景图片。
  * bg_image_draw_type 背景图片的 [绘制方式](image_draw_type.html)。
  * fg_image 前景图片。用途视具体控件而定，如进度条已完成部分的图片使用前景图片。
  * fg_image_draw_type 前景图片的 [绘制方式](image_draw_type.html)。
  ...
  * self_layout 自身布局参数。请参考 [控件布局参数文档](layout.html)
  * children_layout 子控件布局参数。请参考 [控件布局参数文档](layout.html)
  * focusable 是否支持焦点停留。
...
参考： 
  ...
  * [AWTK 中图片的绘制方式](image_draw_type.html)
