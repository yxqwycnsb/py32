# 弹性自身布局器 (self_layouter_flex) 介绍

## 概述

弹性自身布局器 (self_layouter_flex) 是基于 [缺省的控件自身布局器(self_layouter_default)](https://github.com/zlgopen/awtk/blob/master/docs/self_layouter_default.html) 布局器作扩展，用法上是兼容缺省的控件自身布局器的。
