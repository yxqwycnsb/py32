...
list_view_h_t是[widget_t](widget_t.html)的子类控件，widget_t的函数均适用于list_view_h_t控件。
...
> 
> 更多用法请参考：[list_view_h.xml](https://github.com/zlgopen/awtk/blob/master/design/default/ui/list_view_h.xml)
