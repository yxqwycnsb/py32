...
> 创建iostream对象。目前支持： * tcp client: tcp://host:port * udp client: udp://host:port * serial : serial://device?baudrate=115200&stopbits=1 * serial : serial://device?baudrate=115200&stopbits=1&parity=odd&flowcontrol=soft&bytesize=8
