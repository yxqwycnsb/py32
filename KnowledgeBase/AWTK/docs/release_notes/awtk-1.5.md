...
### 5\. 新增重要 API
  ...
  * 新增类 object_locker
  * 新增函数 emitter_exist
  * 新增函数 str_append_more。
  * 新增函数 tk_wstr_dup_utf8
  * 新增函数 fs_os_file_tell
  * 新增函数 fs_os_file_size
  * 新增函数 fs_os_file_stat
  * 新增函数 fs_os_file_sync
  * 新增函数 tk_mutex_try_lock
  * 新增函数 widget_get_text_utf8
  * 新增函数 canvas_get_font_height
  * 新增函数 date_time_get_month_name 
  * 新增函数 date_time_get_wday_name
