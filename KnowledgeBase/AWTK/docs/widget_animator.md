...
#### 1\. 方法一：通过函数 widget_create_animator。
...
#### 4\. widget_animator_opacity 动画的参数
...
#### 6\. widget_animator_rotation 动画的参数
